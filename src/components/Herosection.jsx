...
const Herosection = () => {
  ...
  <img src={Img1} alt="" className="h-[220px] sm:h-auto" />
  <div data-aos='slide-top' className="absolute mt-10  top-10 left-3  md:top-20 md:left-10">
    ...
    <button className="text-sm bg-white text-black border border-gray-300 px-2 md:px-10 py-1 my-3 rounded-md hover:bg-[#25285A] hover:text-white transition-colors duration-300">View More</button>
  </div>
</div>
                ...
                <div className="relative">
                    <img src={Img2} alt="" className="h-[220px] sm:h-auto" />
                    <div className="absolute mt-10 top-10 left-3 md:top-20 md:left-10">
                        <h5 className="text-[16px] md:text-[3rem] font-roboto font-bold">MODULAR</h5>
                ...
                <div className="relative">
                    <img src={Img3} alt="" className="h-[220px] sm:h-auto"/>
                    <div className="absolute mt-10 top-10 left-3 md:top-20 md:left-10">
                        <h5 className="text-[16px] md:text-[3rem] font-roboto font-bold">MODULAR</h5>
